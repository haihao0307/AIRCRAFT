"""Build W05. Only frozen library/CSS inputs and readable generation code are used."""
...
def main(vendor,output):
 ...
 own=['reference-reader.js','sideplate.js','context.js','surface.js','workbench.js']
 ...
 info={'schema':'aircraft.w05.build/1','scope':'Published-W04 shape retained; ageing parameters and optional whole-reference context; complete independent gun not finished','bytes':output.stat().st_size,'sha256':digest(output.read_bytes()),'inputCode':{n:digest((ROOT/n).read_bytes()) for n in own+['index.template.html','page.py','build.py']},'vendor':LOCK,'embeddedReferenceMeshes':0,'embeddedReferenceTextures':0,'sourceUpload':False,'requiresLocalReferenceSelection':False,'optionalReferenceComparison':True,'independentSideplateCandidateBuilt':True,'completeReplicaFinished':False,'oldWorkDeleted':False}
