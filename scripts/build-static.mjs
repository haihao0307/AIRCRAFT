...
await cp('public/livery-production-line.html', 'dist/livery-production-line.html');
...
console.log('Published the model-agnostic historical livery production line.');
