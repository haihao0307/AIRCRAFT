  ...
  for(const mesh of aircraft.meshes){
    ...
    if(family==='propeller'&&mesh.geometry.index.count/3===1119&&path.includes('_still_')){
      ...
      material.onBeforeCompile=shader=>{
        ...
        `);
      };material.customProgramCacheKey=()=> 'b24-r9-propeller-badge';mesh.material=material;bladeCount++;continue;
    }
    ...
    if(TIRE_IDS.has(id)){
      mesh.material.onBeforeCompile=shader=>{
        ...
        `);
      };mesh.material.customProgramCacheKey=()=> 'b24-r9-dusty-rubber';
    }
    if(id===1669){
      mesh.material.onBeforeCompile=shader=>{
        ...
        `);
      };mesh.material.customProgramCacheKey=()=> 'b24-r9-engine-metals';
    }
