...
- port-side shark mouth
- pin-up figure
- exact nickname `UBANGI BAG III`
- two rows of bomb mission marks
- tail serial `42-73436`
- faded olive-drab upper finish
- aged light-gray lower finish
